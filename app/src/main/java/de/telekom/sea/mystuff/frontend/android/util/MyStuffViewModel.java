...
public class MyStuffViewModel extends ViewModel {
    ...
    public void initWithApplication(Application application) {
        initContext(((MyStuffApplication)application).getMyStuffContext());  // Kommt aus MainActivity / damit bekommt die MainActivity/ViewModel die Referenz (Variable wird gesetzt)von MyStuffViewModel.
    }
